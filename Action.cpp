...
void Action::studyAtLibrary(Stats & playerStats) {
    ...
    cout << "All of these actions result in a loss of 5 points to your strength, stamina, and charisma. " << endl;

    int decreasestr =  playerStats.getStrength() - 5;
    
    playerStats.setStrength(decreasestr);

    int decreasestam =  playerStats.getStamina() - 5;
    
    playerStats.setStamina(decreasestam);

    int decreasechr =  playerStats.getCharisma() - 5;
...
void Action::goToParty(Stats & playerStats) {
    ...
    cout << "All of these actions result in a loss of 5 points to your strength, stamina, and intelligence. " << endl;
    ...
    int decreaseiq =  playerStats.getIntelligence() - 5;
...
void Action::eatAtGlassgow(Stats & playerStats) {
    ...
    cout << "All of these actions result in a loss of 5 points to your strength, charisma, and intelligence. " << endl;
...
void Action::workoutAtSRC(Stats & playerStats) {
    ...
    cout << "All of these actions result in a loss of 5 points to your stamina, charisma, and intelligence. " << endl;
