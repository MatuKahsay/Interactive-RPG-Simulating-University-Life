...
void display::UpdateTravel(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	...
	if (ImGui::Button("Continue")) {
		currScene = game->getScene(game->getNextScene());
	}
}

void display::UpdateHub(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	ImGui::Image((void*)(intptr_t)my_image_texture, ImVec2(my_image_width, my_image_height));
...
void display::UpdateSRC(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	ImGui::Image((void*)(intptr_t)my_image_texture, ImVec2(my_image_width, my_image_height));
...
void display::UpdateParty(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	ImGui::Image((void*)(intptr_t)my_image_texture, ImVec2(my_image_width, my_image_height));
...
void display::UpdateLibrary(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	ImGui::Image((void*)(intptr_t)my_image_texture, ImVec2(my_image_width, my_image_height));
...
void display::UpdateGlasgow(GLuint my_image_texture, int my_image_width, int my_image_height, scene*& currScene, GameLogic* game, Player*& player)
{
	ImGui::Image((void*)(intptr_t)my_image_texture, ImVec2(my_image_width, my_image_height));
...
void display::Update(GLuint &my_image_texture, int &my_image_width, int &my_image_height, scene* &currScene, string &currPicture, GameLogic* game, Player* &player)	{
	...
	if (currScene->sceneType == "Traveling") {															//Traveling
		UpdateTravel(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	...
	if (currScene->sceneType == "Hub") {																//Hub
		...
		UpdateHub(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	...
	if (currScene->sceneType == "SRC") {																//SRC
		...
		UpdateSRC(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	...
	if (currScene->sceneType == "Party") {																//Party
		...
		UpdateParty(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	...
	if (currScene->sceneType == "Library") {															//Library
		...
		UpdateLibrary(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	...
	if (currScene->sceneType == "Glasgow") {															//Glasgow
		...
		UpdateGlasgow(my_image_texture, my_image_width, my_image_height, currScene, game, player);
	}
	ImGui::End();
}
